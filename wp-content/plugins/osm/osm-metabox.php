...
<div class="osm-tab-container">
 ...
 <!-- id="tab_marker" -->
    <div id="tab_marker" class="tab-content current">
      ...
      <select name="osm_marker_map_type" id="osm_marker_map_type">
      <?php include('osm-maptype-select.php'); ?>
      </select>
      <b>2. <?php _e('map border','OSM') ?></b>:
      <select name="osm_marker_border" id="osm_marker_border">
      <?php include('osm-color-select.php'); ?>
      </select>
      <b>3. <?php _e('marker id','OSM') ?></b>:
      <select name="osm_marker_id" id="osm_marker_id">
      ...
      <br/>
      <b>4. <?php _e('map controls','OSM') ?></b>:
        <input type="checkbox" name="fullscreen" id="fullscreen" value="fullscreen"> <?php _e('fullscreen','OSM') ?>
        <input type="checkbox" name="scaleline" id="scaleline" value="scaleline"> <?php _e('scaleline','OSM') ?>
        <input type="checkbox" name="mouseposition" id="mouseposition" value="mouseposition"> <?php _e('mouse position','OSM') ?> <br/><br/>
  ...
  <ol>
    ...
    <div id="tab_add_marker" class="tab-content">
      ...
      <select name="osm_add_marker_id" id="osm_add_marker_id">
      <option value="1">01</option><option value="2">02</option><option value="3">03</option>
      <option value="4">04</option><option value="5">05</option><option value="6">06</option>
      <option value="7">07</option><option value="8">08</option><option value="9">09</option>
      </select><br/>
      <b>2. <?php _e('marker name','OSM') ?></b>:
        <input name="osm_add_marker_name" id="osm_add_marker_name" type="text" size="20" maxlength="30" value="NoName"><br/>
